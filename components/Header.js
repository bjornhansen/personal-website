    ...
    <header className='flex flex-col md:flex-row space-y-6 md:space-y-0 justify-between items-center p-4'>
      ...
      <div className={`flex space-x-3`}>
        ...
        <span className={`hover:text-slate-600`}>
          <a
            target='_blank'
            href={`https://docs.google.com/document/d/e/2PACX-1vRTOG0DPT0GjcqezQztmnvFAw6tiR3StPyr6u1gcVZWiT9d4fTkpn-No-1VRDtQkBjiQPIIKMMNqLKm/pub`}
          >
            Résumé
          </a>
        </span>
        ...
        <span className={`hover:text-slate-600`}>
          <a href='mailto:blmhansen@gmail.com'>Contact</a>
        </span>
      </div>
    </header>
  )
